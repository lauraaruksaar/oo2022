...
public class ProductController {
    ...
    public String prindiLogidesse() {
        ...
        return "Logidesse edukalt prindidtud";
    }
    ...
    @GetMapping("lisa-sona/{sona}") //1. localhost:8080/lisa-sona/kass 2. localhost:8080/lisa-sona/koer
    public List<String> saaSonad(@PathVariable String sona) {
        s6nad.add(sona);
        return s6nad; //["kass", "koer"]
    ...
    //401 -- need authentication, saad ligi kui autendid
